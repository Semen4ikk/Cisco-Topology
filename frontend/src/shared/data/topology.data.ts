export const mockHybridNetwork = {
    nodes: [
        // Сервера кольцевые
        { data: { id: "server-1", label: "Server 1", type: "server", status: "online", cpu: "80%", ram: "64GB" }, classes: "ring", },
        { data: { id: "server-2", label: "Server 2", type: "server", status: "online", cpu: "45%", ram: "32GB" }, classes: "ring", },
        { data: { id: "server-3", label: "Server 3", type: "server", status: "online", cpu: "80%", ram: "64GB" }, classes: "ring", },
        { data: { id: "server-4", label: "Server 4", type: "server", status: "online", cpu: "80%", ram: "64GB" }, classes: "ring", },
        { data: { id: "server-5", label: "Server 5", type: "server", status: "online", cpu: "80%", ram: "64GB" }, classes: "ring", },
        { data: { id: "server-6", label: "Server 6", type: "server", status: "online", cpu: "80%", ram: "64GB" }, classes: "ring", },
        ...
        { data: { id: "router-3", label: "router 3", type: "router", status: "online", cpu: "80%", ram: "64GB" }, classes: "tree", },
        { data: { id: "computer-12", label: "computer 12", type: "computer", status: "online", cpu: "80%", ram: "64GB" }, classes: "tree", },
        { data: { id: "computer-13", label: "computer 13", type: "computer", status: "online", cpu: "80%", ram: "64GB" }, classes: "tree", },
